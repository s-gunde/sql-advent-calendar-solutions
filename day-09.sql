...
SELECT tinsel_colors.color_name AS tinsel_color, light_colors.color_name AS light_color,
tinsel_colors.color_name || '-' || light_colors.color_name AS tinsel_light_combo
FROM tinsel_colors
